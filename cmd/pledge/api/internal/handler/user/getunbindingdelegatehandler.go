...
func GetUnbindingDelegateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		l := user.NewGetUnbindingDelegateLogic(r.Context(), svcCtx)
		resp, err := l.GetUnbindingDelegate()
		if err != nil {
			switch err.(type) {
			case merror.GzErr:
